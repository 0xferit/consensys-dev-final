**27 Agu 2018 Warning: Since today, uPort started to fail routing transactions to ethereum network. This broke file upload functionality of the UI Until it gets back to normal you can use [writeContract interface of EtherScan](https://rinkeby.etherscan.io/address/0x333d960578e9c7f03081ed6c6f7b4ea7e6ed0b24#writeContract) to add a new hash to the registry.**
